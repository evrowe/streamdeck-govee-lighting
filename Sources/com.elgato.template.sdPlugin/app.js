...
function connected(jsn) {
    ...
    $SD.on('com.evrowe.govee-lighting.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.evrowe.govee-lighting.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.evrowe.govee-lighting.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.evrowe.govee-lighting.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.evrowe.govee-lighting.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.evrowe.govee-lighting.action.propertyInspectorDidDisappear', (jsonObj) => {
